...
error.tag.notfound=Taggen <b>{0}</b> har blitt filtrert av sikkerhetsgrunner. Innholdet i taggen vil bli værende.
error.tag.removed=The <b>{0}</b> tag is not allowed for security reasons. This tag should not affect the display of the input.
error.tag.removed=Taggen <b>{0}</b> er ikke lovlig av sikkerhetsgrunner. Denne taggen skulle ikke påvirke visningen av inndataene. 
error.tag.filtered=The <b>{0}</b> tag has been filtered for security reasons. The contents of the tag will remain in place.
error.tag.filtered=Taggen <b>{0}</b> har blitt filtrert av sikkerhetsgrunner. Innholdet i taggen vil bli værende.
...
error.attribute.notfound=Taggen <b>{0}</b> inneholdt et attributt som ikke kunne behandles. Attributtet <b>{1}</b> har blitt filtrert vekk men taggen er fremdeles på plass.
...
error.css.stylesheet.rule.notfound=<b>Stilarket</b> bruker en regel, <u>\"{0}\"</u>, som ikke er støttet. Regelen har blitt fjernet av sikkerhetsgrunner. 
...
error.css.tag.rule.notfound=Taggen <b>{0}</b> hadde en stilattributt som bruker en regel, <u>\"{1}\"</u>, som ikke er støttet. Regelen har blitt fjernet av sikkerhetsgrunner.
